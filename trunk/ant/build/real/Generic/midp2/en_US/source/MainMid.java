...
StyleSheet.display = javax.microedition.lcdui.Display.getDisplay( this );        initialize();
    ...
    public void createMenu() {
        //#style mainScreenE
        menuScreen = new List("JCage", List.IMPLICIT, StyleSheet.mainscreeneStyle );
        //#style mainCommandE
        menuScreen.append("Game room", getImage("/game.png"), StyleSheet.maincommandeStyle );
        //#style mainCommandE
        menuScreen.append("Phone Speed", getImage("/speed.png"), StyleSheet.maincommandeStyle );
        //#style mainCommandE
        menuScreen.append("Help", getImage("/help.png"), StyleSheet.maincommandeStyle );
        //#style mainCommandE
        menuScreen.append("Exit", getImage("/exit.png"), StyleSheet.maincommandeStyle );
    }
