...
public class FormUnits extends Form implements CommandListener, ChildForm {
    ...
    public FormUnits(String s, ChildForm parent, boolean select) {
        ...
        this.parent = parent;
        //#style mainScreenBE
        this.menuScreen = new List("Buildings", List.IMPLICIT, StyleSheet.mainscreenbeStyle );
        ...
        while (en.hasMoreElements()) {
            ...
            if (b.getType().equals("uni")) {
                //#style mainCommandBE
                menuScreen.append(b.getId(), MainMid.getImage("/" + b.getId() + "_a.png"), StyleSheet.maincommandbeStyle );
