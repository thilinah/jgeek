...
implements PlayerListener
{
	 ...
	 * 
	 * @return the original player, this can be null when no audio has been played back so far.
	 */
	 ...
	 * @param protocol the protocol, when null is given the content type will be returned for any protocol
	 * @return the type supported by the device, for example "audio/mpeg3" - null when the given type is not supported by the device.
	 */
	public static String getAudioType( String type, String protocol ) {
		...
		String[] supportedContentTypes = Manager.getSupportedContentTypes( protocol );
		...
		if (mappings == null) {
			//#debug warn
			//# System.out.println("The audio content type " + type + " has no known synonyms.");
