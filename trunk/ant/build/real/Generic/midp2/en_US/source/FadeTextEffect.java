...
public class FadeTextEffect extends TextEffect {
	...
	public void setStyle(Style style) {
		...
		//#if polish.css.text-fade-out-color
			//# Color startColorObj = style.getColorProperty( 175 );
